...
if (!isset($excluded_functions['array_exists']) && (!function_exists('ryunosuke\\Documentize\\array_exists') || (!false && (new \ReflectionFunction('ryunosuke\\Documentize\\array_exists'))->isInternal()))) {
    /**
